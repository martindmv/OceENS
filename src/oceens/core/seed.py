...
# Données de seed livrées avec le paquet (src/oceens/import/)
...
# Un utilisateur par rôle à périmètre, sans aucun autre rôle : les rôles
# program_manager et campus_manager ci-dessus sont cumulés avec admin. Les
# périmètres correspondent aux sondages de seed (MDAI5 / Montpellier).
SINGLE_ROLE_USERS = [
